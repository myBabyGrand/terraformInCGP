...
#   name         = "vm-${var.business_app_1_app_vm_config.vm_name}-prod-0"
...
#   boot_disk {
#     initialize_params {
#       image = var.business_app_1_app_vm_config.vm_image
#       size  = var.business_app_1_app_vm_config.boot_disk_size
#       type  = var.business_app_1_app_vm_config.vm_boot_disk_type
#     }
#   }

#   metadata_startup_script = var.business_app_1_app_vm_config.vm_startup_script
